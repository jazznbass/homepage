...
values 0 *or* 1) with a standard *ols* regression the distribution of
...
distributed. A common solution for this problem is to a apply a
...
via a function which is called: the link function.
...
against 1 ($4\over1$), than out of 5 events, 4 have one category of
