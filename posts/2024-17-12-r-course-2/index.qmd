...
abstract: Slides for seminar on R
categories:
  - teaching
  - R
  - regression
format: 
  revealjs:
    ...
    title-slide-attributes:
      data-background-image: img/bg-digital-data.jpg
...
# Extending R {background-image="img/bg-h1-3.jpg"}
...
::: incremental
-   You find a list of all CRAN packages on <https://cran.r-project.org/> ![](img/right_arrow.jpg){width="30"} Packages
...
# R Studio projects {background-image="img/bg-h1-3.jpg"}
...
1.  File ![](img/right_arrow.jpg){width="30"} New Project ...
...
-   Open the project through:
    -   File ![](img/right_arrow.jpg){width="30"} Recent projects
    -   Or the project menue in the upper right corner of R Studio

# External data {background-image="img/bg-h1-3.jpg"}
...
-   Alternatively: R Studio provided an easy way to import data:\
    File ![](img/right_arrow.jpg){width="30"} Import Dataset ![](img/right_arrow.jpg){width="30"} From Excel
...
## Goals {.emphasized .flexbox .vcenter data-background="img/DEFOCUSED.png" data-background-size="cover"}

-   You know what mardown is.
-   You know what you can do with Rmarkdown.
-   You can create your own Rmarkdown files.

# Markdown and Rmarkdown {background-image="img/bg-h1-3.jpg"}
...
-   Create a new source file in R. Choose ***"Text File"*** as the format.\
    File ![](img/right_arrow.jpg){width="30"} New File ![](img/right_arrow.jpg){width="30"} Text File
-   Save it under the name "first_mardown.Rmd"\
    (you can name it as you like as long as it ends with ".Rmd").
-   Now, at the lower right corner of your source panel you should find ![](img/Rmarkdown_dropdown.png){hight="30"} as an indicator of the file type.
-   Also, at the top of the source file you should find ![](img/knit_symbol.png){hight="30"}

# Basic markdown formating {background-image="img/bg-h1-3.jpg"}
...
# Rmarkdown {background-image="img/bg-h1-3.jpg"}
...
# Tidyverse {background-image="img/bg-h1-3.jpg"}
...
# Pipes: `%>%`  {background-image="img/bg-h1-3.jpg"}
...
# From wide to long {background-image="img/bg-h1-3.jpg"}
...
# Join datasets {background-image="img/bg-h1-3.jpg"}
...
## Goals {background-image="img/bg-h1-3.jpg"}
...
![](img/ggplot_layers.png){width="800"}


## Prerequisite {background-image="img/bg-h1-3.jpg"}

You have basic knowledge on statistical regression

## Goal {background-image="img/bg-h1-3.jpg"}
...
# Multilevel regressions {background-image="img/bg-h1-3.jpg"}
...
# Control-Functions {background-image="img/bg-h1-3.jpg"} 
